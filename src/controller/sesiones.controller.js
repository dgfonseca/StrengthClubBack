              ...
              <html ⚡4email> \
                ...
                <body> \
                  <div class="container"> \
                    ...
                    <p class="content">Le informamos que ha consumido la totalidad de las sesiones de su paquete adquirido. Para tu su, el sistema te ha asignado un nuevo paquete de sesiones igual al último que compró.</p> \
...
const getSesiones = async (request,response) =>{
  ...
  try {
    ...
    res = await pool.query("SELECT ses.asistio,ses.id,ses.entrenador,ses.cliente,TO_CHAR(ses.fecha,'YYYY-MM-DD HH24:MI'),ent.color as color, \
