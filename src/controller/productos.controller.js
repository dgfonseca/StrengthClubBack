...
try {
  ...
  if(nombre && codigo && descripcion && inventario && precio){
      if(inventarioAdicional && inventarioAdicional!==0){
        ...
        await client.query("INSERT INTO historico_productos(producto,inventario,precioCompra,precio,fechaInicio,fechaFin) VALUES($1,$2,$3,$4, ,null)", [codigo, inventarioAdicional,precioCompra,precio])
      }else{
