      ...
      if(cuenta.rows[0].habilitado){
        ...
        return {
          html: '<!doctype html><html lang="es"><head><meta charset="utf-8"></head><body style="margin:0;padding:16px;font-family:Arial,sans-serif;background:#fafafa;color:#222">' 
            ...
            + '<p style="font-size:13px;line-height:1.5;color:#444;margin:0 0 16px">Nota: <strong>TOTAL A PAGAR</strong> incluye tus suplementos y las sesiones efectivamente agendadas. Si encuentras alguna discrepancia en los horarios de tus sesiones, por favor avísanos para revisarlo con tu coach. Te recordamos que los paquetes se cobran de forma anticipada. En cuanto consumas la totalidad de tu paquete actual, el sistema generará una nueva compra automáticamente y recibirás una notificación de confirmación en tu correo electrónico.</p>'
            + '</body></html>',
...
module.exports = {sendAllEmail,getCorreo,getDetalleContabilidadCliente,crearCliente,getClientes,deleteClientes,updateCliente, getContabilidadClientes,postAbono,sendEmail,getAbonos,deleteAbono, getAbonosCliente}